...
object Implicits {
  ...
  implicit class RichIterable[A, Repr](iter: GenIterableLike[A, Repr]) {

    def mapWithIndex[B, Repr2 <: GTL[(A, Int), Repr2], That2](f: (A, Int) => B)(
      implicit bf1: CBF[Repr, (A, Int), Repr2], bf2: CBF[Repr2, B, That2]): That2 =
      {
